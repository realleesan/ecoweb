...
--
-- Cơ sở dữ liệu: `growhope_db`
--
CREATE DATABASE IF NOT EXISTS `growhope_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `growhope_db`;
...
CREATE TABLE `products` (
  ...
  `eco_benefits` text DEFAULT NULL,
  ...
  `suitable_soil` varchar(255) DEFAULT NULL,
