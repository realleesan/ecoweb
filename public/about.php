...
<main style="min-height: 60vh; padding: 60px 5%; background-color: var(--white);">
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <section style="margin-bottom: 60px;">
            <h1 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 36px; color: var(--primary); margin-bottom: 30px; text-align: center; position: relative; padding-bottom: 20px;">
                Câu chuyện GrowHope
            ...
            <div style="background-color: #f8f9fa; padding: 40px; border-radius: 10px; border-left: 5px solid var(--secondary);">
                <p style="font-family: 'Poppins', sans-serif; font-weight: 400; font-size: 16px; line-height: 1.8; color: var(--dark); text-align: justify; margin: 0;">
        ...
        <!-- Tầm nhìn & Sứ mệnh -->
        <section style="margin-bottom: 60px;">
            <h2 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 32px; color: var(--primary); margin-bottom: 30px; text-align: center; position: relative; padding-bottom: 20px;">
                Tầm nhìn & Sứ mệnh
                <span style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 100px; height: 3px; background: var(--secondary);"></span>
            </h2>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
                <div style="background: linear-gradient(135deg, var(--primary) 0%, #4a7a4a 100%); padding: 35px; border-radius: 10px; color: var(--white); box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                    <h3 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 24px; color: var(--white); margin-bottom: 20px; display: flex; align-items: center;">
                        <i class="fas fa-eye" style="margin-right: 10px; color: var(--secondary);"></i>
                        Tầm nhìn
                    </h3>
                    <p style="font-family: 'Poppins', sans-serif; font-weight: 400; font-size: 15px; line-height: 1.8; color: rgba(255,255,255,0.95); margin: 0;">
        ...
        <section style="margin-bottom: 60px;">
            ...
            <div style="background: linear-gradient(135deg, var(--secondary) 0%, #e87a3a 100%); padding: 30px; border-radius: 10px; margin-bottom: 30px; text-align: center; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                <p style="font-family: 'Poppins', sans-serif; font-weight: 400; font-size: 18px; line-height: 1.8; color: var(--white); margin: 0;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 25px;">
                <div style="background-color: var(--white); padding: 30px; border-radius: 10px; border: 2px solid var(--primary); box-shadow: 0 3px 10px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 5px 20px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 3px 10px rgba(0,0,0,0.1)'">
                    ...
                    <h3 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 20px; color: var(--primary); margin-bottom: 15px; text-align: center;">
                        Thanh liêm
                    </h3>
                    <p style="font-family: 'Poppins', sans-serif; font-weight: 400; font-size: 15px; line-height: 1.7; color: var(--dark); text-align: center; margin: 0;">
